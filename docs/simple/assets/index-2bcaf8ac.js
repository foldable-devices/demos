...
@lit/reactive-element/decorators/query-assigned-nodes.js:
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/var ee=class extends T{constructor(){super(...arguments),this.hasSlotController=new fe(this,"footer","header","image")}render(){return K`
      <div
        part="base"
