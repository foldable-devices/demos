 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function bt(e,t){return(o,r,i)=>{const s=n=>{var c;return((c=n.renderRoot)==null?void 0:c.querySelector(e))??null};if(t){const{get:n,set:c}=typeof r=="object"?o:i??(()=>{const l=Symbol();return{get(){return this[l]},set(a){this[l]=a}}})();return Jt(o,r,{get(){let l=n.call(this);return l===void 0&&(l=s(this),(l!==null||this.hasUpdated)&&c.call(this,l)),l}})}return Jt(o,r,{get(){return s(this)}})}}var A=class extends D{constructor(){super(),Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){const o=new CustomEvent(e,q({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(o),o}static define(e,t=this,o={}){const r=customElements.get(e);if(!r){customElements.define(e,class extends t{},o);return}let i=" (unknown version)",s=i;"version"in t&&t.version&&(i=" v"+t.version),"version"in r&&r.version&&(s=" v"+r.version),!(i&&s&&i===s)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${s} has already been registered.`)}};A.version="2.15.0";A.dependencies={};d([p()],A.prototype,"dir",2);d([p()],A.prototype,"lang",2);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},be=e=>(...t)=>({_$litDirective$:e,values:t});class ve{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,o,r){this._$Ct=t,this._$AM=o,this._$Ci=r}_$AS(t,o){return this.update(t,o)}update(t,o){return this.render(...o)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const W=be(class extends ve{constructor(e){var t;if(super(e),e.type!==M.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,i;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!((r=this.nt)!=null&&r.has(s))&&this.st.add(s);return this.render(t)}const o=e.element.classList;for(const s of this.st)s in t||(o.remove(s),this.st.delete(s));for(const s in t){const n=!!t[s];n===this.st.has(s)||(i=this.nt)!=null&&i.has(s)||(n?(o.add(s),this.st.add(s)):(o.remove(s),this.st.delete(s)))}return k}});var ge=class extends A{constructor(){super(...arguments),this.hasSlotController=new ft(this,"footer","header","image")}render(){return T`
      <div
        part="base"
  ...
  `},po={name:"system",resolver:e=>e in Xt?`data:image/svg+xml,${encodeURIComponent(Xt[e])}`:""},fo=po,bo=[uo,fo],Pt=[];function vo(e){Pt.push(e)}function go(e){Pt=Pt.filter(t=>t!==e)}function te(e){return bo.find(t=>t.name===e)}var mo=C`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`,v=class extends A{constructor(){super(...arguments),this.formControlController=new Ce(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new ft(this,"[default]","prefix","suffix"),this.localize=new It(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Rt}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?ut`a`:ut`button`;return dt`
    ...
    `}};v.styles=[R,Uo];v.dependencies={"sl-icon":S,"sl-spinner":Se};d([bt(".button")],v.prototype,"button",2);d([st()],v.prototype,"hasFocus",2);d([st()],v.prototype,"invalid",2);d([p()],v.prototype,"title",2);d([p({reflect:!0})],v.prototype,"variant",2);d([p({reflect:!0})],v.prototype,"size",2);d([p({type:Boolean,reflect:!0})],v.prototype,"caret",2);d([p({type:Boolean,reflect:!0})],v.prototype,"disabled",2);d([p({type:Boolean,reflect:!0})],v.prototype,"loading",2);d([p({type:Boolean,reflect:!0})],v.prototype,"outline",2);d([p({type:Boolean,reflect:!0})],v.prototype,"pill",2);d([p({type:Boolean,reflect:!0})],v.prototype,"circle",2);d([p()],v.prototype,"type",2);d([p()],v.prototype,"name",2);d([p()],v.prototype,"value",2);d([p()],v.prototype,"href",2);d([p()],v.prototype,"target",2);d([p()],v.prototype,"rel",2);d([p()],v.prototype,"download",2);d([p()],v.prototype,"form",2);d([p({attribute:"formaction"})],v.prototype,"formAction",2);d([p({attribute:"formenctype"})],v.prototype,"formEnctype",2);d([p({attribute:"formmethod"})],v.prototype,"formMethod",2);d([p({attribute:"formnovalidate",type:Boolean})],v.prototype,"formNoValidate",2);d([p({attribute:"formtarget"})],v.prototype,"formTarget",2);d([V("disabled",{waitUntilFirstUpdate:!0})],v.prototype,"handleDisabledChange",1);v.define("sl-button");var Oo=C`
  :host {
    display: inline-block;
  }
...
`,Io=(e="value")=>(t,o)=>{const r=t.constructor,i=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(s,n,c){var l;const a=r.getPropertyOptions(e),u=typeof a.attribute=="string"?a.attribute:e;if(s===u){const h=a.converter||F,b=(typeof h=="function"?h:(l=h==null?void 0:h.fromAttribute)!=null?l:F.fromAttribute)(c,a.type);this[e]!==b&&(this[o]=b)}i.call(this,s,n,c)}},Ro=C`
