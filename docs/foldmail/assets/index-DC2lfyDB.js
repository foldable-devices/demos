...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}(k.querySelectorAll("."+v));!(A=S()).done;)A.value.remove();var z=document.createElement("style");z.className=v,z.textContent=I,k===document?document.head.appendChild(z):k.appendChild(z)};if(t){var P=t.shadowRoot;"adoptedStyleSheets"in P&&P.adoptedStyleSheets.length>0?P.adoptedStyleSheets[0].replace(s+o):b(P,o)}else b(document,o)}}const Z={Foldable:"foldable",Dual:"dual"};class zt extends mt{}g(zt,"styles",yr`
  ...
  `);customElements.define("foldable-device-configurator",Ur);const An=(t,...e)=>{const i=_i(t[0],"list-item");return q([i],...e)};class Mr extends Q{constructor(){super()}connectedCallback(){super.connectedCallback(),xe(this)}render(){return et`
        <div class="content">
  ...
  `);customElements.define("list-item",Mr);const En=(t,...e)=>{const i=_i(t[0],"email-panel");return q([i],...e)};class Nr extends Q{constructor(){super()}connectedCallback(){super.connectedCallback(),xe(this)}render(){return et`
        <div class="content">
