...
export class MainApplication extends LitElement {
  ...
  firstUpdated() {
    ...
    if (typeof FoldablesFeature != 'undefined') {
      const foldablesFeat = new FoldablesFeature(); // This is specific for the polyfill, the browser window won't be resized.
  ...
  constructor() {
    ...
    _defineProperty(this, "_mainMenu", void 0);

    _defineProperty(this, "_pauseMenu", void 0);

    _defineProperty(this, "_aboutMenu", void 0);

    _defineProperty(this, "_lostMenu", void 0);

    _defineProperty(this, "_pauseButton", void 0);

    _defineProperty(this, "_pauseButtonPos", {
      x: 0,
      y: 0
    });

    _defineProperty(this, "_pauseButtonSize", 80);

    _defineProperty(this, "_ship", void 0);

    _defineProperty(this, "_shipSize", 80);

    _defineProperty(this, "_controllerSize", 70);

    _defineProperty(this, "_controllerSizeTouch", 60);

    _defineProperty(this, "_shipObject", {
      x: 0,
      y: 0
    });

    _defineProperty(this, "_background1Y", 0);

    _defineProperty(this, "_background2Y", 0);

    _defineProperty(this, "_meteorSize", 80);

    _defineProperty(this, "_meteorImage", void 0);

    _defineProperty(this, "_meteorImage2", void 0);

    _defineProperty(this, "_meteors", []);

    _defineProperty(this, "_explosionImage", void 0);

    _defineProperty(this, "_currentTime", 0);

    _defineProperty(this, "_startTime", 0);

    _defineProperty(this, "_timeSize", void 0);

    _defineProperty(this, "_timeX", void 0);

    _defineProperty(this, "_timeY", void 0);

    _defineProperty(this, "_velocity", 1);

    _defineProperty(this, "_paused", true);

    _defineProperty(this, "_dead", true);

    _defineProperty(this, "_spanning", false);

    _defineProperty(this, "_playAreaSize", undefined);

    _defineProperty(this, "_controllerArea", undefined);

    _defineProperty(this, "_enableDebug", false);

    _defineProperty(this, "_pointerDown", false);

    _defineProperty(this, "_currentPointerTimeout", []);

    _defineProperty(this, "_pointerId", void 0);

    _defineProperty(this, "_touchSensitivity", 10);

    _defineProperty(this, "_touchingLeftController", false);

    _defineProperty(this, "_touchingRightController", false);

    _defineProperty(this, "_touchingUpController", false);

    _defineProperty(this, "_touchingDownController", false);

    _defineProperty(this, "_yButtonImage", void 0);

    _defineProperty(this, "_yButtonSize", 100);

    _defineProperty(this, "_yButtonPos", {
      x: 0,
      y: 0
    });

    _defineProperty(this, "_touchingYButton", false);

    _defineProperty(this, "_missileImage", void 0);

    _defineProperty(this, "_missileWidth", 20);

    _defineProperty(this, "_missileHeight", 30);

    _defineProperty(this, "_missiles", []);
    ...
    _defineProperty(this, "_onPointerDown", async event => {
      ...
      if (this._touchingLeftController || this._touchingRightController || this._touchingUpController || this._touchingDownController) {
        ...
        if (this._touchingLeftController) {
          this._moveShipLeft();
        } else if (this._touchingRightController) this._moveShipRight();else if (this._touchingUpController) this._moveShipUp();else if (this._touchingDownController) this._moveShipDown();

        this._currentPointerTimeout.push(setTimeout(direction => this._simulateLongPress(this._touchingLeftController, this._touchingRightController, this._touchingUpController, this._touchingDownController), 300));
      }

      this._touchingYButton = this._isTouchingYButton(event);
      if (this._touchingYButton) this._fireMissile();
    });
    ...
    _defineProperty(this, "_onPointerUp", async event => {
      if (this._paused || this._dead) return;
      this._pointerDown = false;
      this._touchingLeftController = this._touchingRightController = this._touchingUpController = this._touchingDownController = this._touchingYButton = false;
    ...
    _defineProperty(this, "_simulateLongPress", async (isTouchingLeftController, isTouchingRightController, isTouchingUpController, isTouchingDownController) => {
      if (!this._pointerDown) return;
      if (isTouchingLeftController) this._moveShipLeft();else if (isTouchingRightController) this._moveShipRight();else if (isTouchingUpController) this._moveShipUp();else if (isTouchingDownController) this._moveShipDown();

      this._currentPointerTimeout.push(setTimeout(direction => this._simulateLongPress(isTouchingLeftController, isTouchingRightController, isTouchingUpController, isTouchingDownController), 50));
    });

    _defineProperty(this, "_drawCanvas", event => {
      if (this._paused) return;
      ...
      if (this.currentTime % newMeteorSeconds === 0) this._addNewMeteors();
      if (this.currentTime % 30 == 0) this._velocity++;
      requestAnimationFrame(this._drawCanvas);
    });
    ...
    _defineProperty(this, "_onResize", async event => {
      ...
      if (this._paused) this._drawBackground();
    });
  ...
  _startGame() {
    ...
    this._shipObject = {
      x: this._playAreaSize.width / 2 - this._shipSize / 2,
      y: this._playAreaSize.height - this._shipSize,
      size: this._shipSize
    };
    this._background2Y = -this._playAreaSize.height;
    this._background1Y = -this._playAreaSize.height;
    this._touchingYButton = this._touchingLeftController = this._touchingRightController = this._touchingUpController = this._touchingDownController = false;
    this._pointerDown = false;

    this._addNewMeteors();

    if (!this._spanning) this._showPauseButton();
    requestAnimationFrame(this._drawCanvas);
  }
  ...
  _addNewMeteors() {
    ...
    for (let i = 0; i < numberMeteorToAdd; ++i) this._addRandomMeteor();
  }
  ...
  _addRandomMeteor() {
    ...
    for (const meteor of this._meteors) {
      if (this._checkCollision(meteor, {
        x: x,
        y: y,
        size: this._meteorSize
  ...
  _removeMeteor(meteorToRemove) {
    for (let i = this._meteors.length; i--;) {
      ...
      if (meteor.destroyed && meteorToRemove.y == meteor.y && meteorToRemove.x == meteor.x) {
  ...
  _drawShip() {
    if (this._dead) this._context.drawImage(this._explosionImage, this._shipObject.x, this._shipObject.y, this._shipObject.size + 10, this._shipObject.size + 10);else this._context.drawImage(this._ship, this._shipObject.x, this._shipObject.y, this._shipObject.size, this._shipObject.size);
  }

  _drawBackground() {
    this._background1Y = this._background1Y - 1;
    this._background2Y = this._background2Y + 1;
    if (this._background1Y < -2 * this._playAreaSize.height) this._background1Y = 0;
    if (this._background2Y > this._playAreaSize.height) this._background2Y = -this._playAreaSize.height;
  ...
  _drawMeteors() {
    for (const meteor of this._meteors) {
      ...
      if (meteor.destroyed) this._context.drawImage(this._explosionImage, meteor.x, meteor.y, meteor.size, meteor.size);else this._context.drawImage(imagePath, meteor.x, meteor.y, meteor.size, meteor.size);
      ...
      if (!meteor.destroyed && this._checkCollision(meteor, this._shipObject)) this._lostGame();
  ...
  _checkCollision(object1, object2) {
    const overlap = object1.x + object1.size >= object2.x && object1.x <= object2.x + object2.size && object1.y + object1.size >= object2.y && object1.y <= object2.y + object2.size;
    return overlap;
  }
  ...
  _drawController(size) {
    ...
    this._context.drawImage(this._controllerLeftImage, this._leftControllerPos.x, this._leftControllerPos.y, size, size);

    this._drawMiddleController(size);

    this._context.drawImage(this._controllerRightImage, this._rightControllerPos.x, this._rightControllerPos.y, size, size);

    this._context.drawImage(this._controllerUpImage, this._upControllerPos.x, this._upControllerPos.y, size, size);

    this._context.drawImage(this._controllerDownImage, this._downControllerPos.x, this._downControllerPos.y, size, size);
  ...
  _drawMiddleController(size) {
    ...
    this._context.fillRect(this._leftControllerPos.x + size, this._leftControllerPos.y + 1, size, size - 2);

    this._context.beginPath();

    this._context.rect(this._leftControllerPos.x + size, this._leftControllerPos.y + 1, size, size - 2);
  ...
  _drawControllerHighlight(size) {
    ...
    this._context.fillStyle = 'black';
    if (this._touchingLeftController) this._context.fillRect(this._leftControllerPos.x, this._leftControllerPos.y, size, size);else if (this._touchingRightController) this._context.fillRect(this._rightControllerPos.x, this._rightControllerPos.y, size, size);else if (this._touchingUpController) this._context.fillRect(this._upControllerPos.x, this._upControllerPos.y, size, size);else if (this._touchingDownController) this._context.fillRect(this._downControllerPos.x, this._downControllerPos.y, size, size);

    this._context.restore();
  }

  _drawPauseButton() {
    this._context.drawImage(this._pauseButton, this._pauseButtonPos.x, this._pauseButtonPos.y, this._pauseButtonSize, this._pauseButtonSize);
  }

  _drawYButton() {
    this._context.drawImage(this._yButtonImage, this._yButtonPos.x, this._yButtonPos.y, this._yButtonSize, this._yButtonSize);
    ...
    if (this._touchingYButton) {
      ...
      this._context.arc(this._yButtonPos.x + this._yButtonSize / 2, this._yButtonPos.y + this._yButtonSize / 2, this._yButtonSize / 2, 0, 2 * Math.PI);
  ...
  _isTouchingPauseButton(event) {
    return event.clientX >= this._pauseButtonPos.x - this._touchSensitivity && event.clientX <= this._pauseButtonPos.x + this._pauseButtonSize + this._touchSensitivity && event.clientY >= this._pauseButtonPos.y - this._touchSensitivity && event.clientY <= this._pauseButtonPos.y + this._pauseButtonSize + this._touchSensitivity;
  }

  _isTouchingYButton(event) {
    return event.clientX >= this._yButtonPos.x - this._touchSensitivity && event.clientX <= this._yButtonPos.x + this._yButtonSize + this._touchSensitivity && event.clientY >= this._yButtonPos.y - this._touchSensitivity && event.clientY <= this._yButtonPos.y + this._yButtonSize + this._touchSensitivity;
  }

  _isTouchingAController(controller, event) {
    return event.clientX >= controller.x - this._touchSensitivity && event.clientX <= controller.x + this._controllerSize + this._touchSensitivity && event.clientY >= controller.y - this._touchSensitivity && event.clientY <= controller.y + this._controllerSize + this._touchSensitivity;
  }
  ...
  _isTouchingController(event) {
    ...
    return isTouchingLeftController || isTouchingRightController || isTouchingUpController || isTouchingDownController;
  }

  _clearPointerTimeout() {
    for (const timer of this._currentPointerTimeout) clearTimeout(timer);

    this._currentPointerTimeout = [];
  }

  _moveShipLeft() {
    if (this._shipObject.x <= 10 || this._paused) return;
    this._shipObject.x -= 10;
  }

  _moveShipRight() {
    if (this._shipObject.x + 10 >= this._playAreaSize.width - this._shipObject.size || this._paused) return;
    this._shipObject.x += 10;
  }

  _moveShipDown() {
    if (this._shipObject.y + 10 >= this._playAreaSize.height - this._shipObject.size || this._paused) return;
    this._shipObject.y += 10;
  }

  _moveShipUp() {
    if (this._shipObject.y <= 10 || this._paused) return;
    this._shipObject.y -= 10;
  }
  ...
  _fireMissile() {
    this._missiles.push({
      ...
      y: this._shipObject.y - 10,
      size: this._missileWidth
    });
  }
  ...
  _handleSpanning() {
    ...
    if (!this._spanning) this._showPauseButton();else this._hidePauseButton();
  ...
  _updateGameLayout() {
    let oldPlayArea;
    if (this._playAreaSize) oldPlayArea = {
    ...
    if (oldPlayArea) {
      ...
      this._makeObjectFitInPlayBoundaries(this._shipObject); // Update meteors positions
  ...
  _makeObjectFitInPlayBoundaries(object) {
    if (object.x < this._playAreaSize.left) object.x = this._playAreaSize.left;else if (object.x + object.size > this._playAreaSize.width) object.x = this._playAreaSize.width - object.size;
    if (object.y < this._playAreaSize.top) object.y = this._playAreaSize.top;else if (object.y + object.size > this._playAreaSize.height) object.y = this._playAreaSize.height - object.size;
  }
